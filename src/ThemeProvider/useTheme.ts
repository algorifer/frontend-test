import { ThemeSettings, Theme } from '../types'

const kLineHeightFixedAmountSize = 0.35
const kLineHeightRelativeAmountSize = 1.1
...
export const useTheme = (settings: ThemeSettings): Theme => {
  const textSizeXS = settings.baseTextSize / settings.textSizeIncrement
  const textSizeS = settings.baseTextSize
  const textSizeM = textSizeS * settings.textSizeIncrement
  const textSizeL = textSizeM * settings.textSizeIncrement
  const textSizeXL = textSizeL * settings.textSizeIncrement

  const spaceSizeS = settings.unit
  const spaceSizeM = spaceSizeS * settings.spaceIncrement
  const spaceSizeL = spaceSizeM * settings.spaceIncrement
  const spaceSizeXL = spaceSizeL * settings.spaceIncrement
  const spaceSizeXXL = spaceSizeXL * settings.spaceIncrement
  const spaceSizeXXXL = spaceSizeXXL * settings.spaceIncrement
  const spaceSizeXXXXL = spaceSizeXXXL * settings.spaceIncrement

  return {
  // Typography
    fontFamily: settings.fontFamily,
    textSizeIncrement: settings.textSizeIncrement,
    baseTextSize: `${settings.baseTextSize}rem`,
    textXS: `${textSizeXS}rem`,
    textS: `${textSizeS}rem`,
    textM: `${textSizeM}rem`,
    textL: `${textSizeL}rem`,
    textXL: `${textSizeXL}rem`,
    globalLineHeight: `${kLineHeightFixedAmountSize + kLineHeightRelativeAmountSize}rem`,
    // Spacing
    unit: `${settings.unit}rem`,
    textFrameY: `${settings.textFrameY}em`,
    textFrameX: `${settings.textFrameY * settings.textFrameRatio}em`,
    spaceS: `${spaceSizeS}rem`,
    spaceM: `${spaceSizeM}rem`,
    spaceL: `${spaceSizeL}rem`,
    spaceXL: `${spaceSizeXL}rem`,
    spaceXXL: `${spaceSizeXXL}rem`,
    spaceXXXL: `${spaceSizeXXXL}rem`,
    spaceXXXXL: `${spaceSizeXXXXL}rem`,
    // Colors
    ...
    fieldBorderWidth: `${settings.fieldBorderWidth}px`,
  }
}